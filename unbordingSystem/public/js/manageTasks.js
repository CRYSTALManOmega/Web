...
function fetchModules() {
    fetch('..\..\src\controller\getManagerModules.php')
...
function fetchAssignedModules() {
    fetch('..\..\src\controller\getAssignedModules.php')
        .then(response => response.json())
        .then(data => {
...
function toggleModuleStatus(moduleId, currentStatus) {
    fetch('..\..\src\controller\toggleModuleStatus.php', {
        method: 'POST',
...
function fetchSubmittedModules() {
    fetch('..\..\src\controller\getSubmittedModules.php')
        .then(response => response.json())
        .then(data => {
...
function toggleSubmissionStatus(submissionId, currentStatus) {
    fetch('..\..\src\controller\toggleSubmissionStatus.php', {
        method: 'POST',
        headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
...
function assignWelcomeVideo(event) {
    ...
    fetch('..\..\src\controller\assignWelcomeVideo.php', {
        method: 'POST',
        body: formData
    })
    .then(response => response.json())
