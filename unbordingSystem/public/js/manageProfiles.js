...
function loadProfiles() {
    fetch('..\..\src\controller\fetchProfiles.php')
...
function showAddProfileForm() {
    window.open("..\..\src\views\addEmployeeInterface.php", "_blank");
}
...
function editProfile(userId) {
    window.location.href = `..\..\src\views\addEmployeeInterface.php?User_Id=${userId}`;
}
